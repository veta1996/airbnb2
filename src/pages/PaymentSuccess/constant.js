...
export const HOLDERNAME = [/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/, /^[a-zA-Z ]*$/, /^[a-zA-Z ]*$/, /^[a-zA-Z ]*$/, /^[a-zA-Z ]*$/, /^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,
/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,
/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,
/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/,/^[a-zA-Z ]*$/ ];
